function [NND_ch_ez_t,NND_munc_t,NND_munc_to_ch,NND_chto_munc_ez]=gen_mod1(xr_i,yr_i,xu_c,yu_c,xm_i,ym_i,le_ca,le_munc)
% generate bivariant pattern as EZ ("Cav" outside EZ, "munc" inside the EZ)
%%input
...
%leave only "munc" that are insde the EZ
